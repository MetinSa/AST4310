...
\end{equation}
Numerically, we compute this by summing $(I_\lambda - I(0))d\lambda/I_\lambda$, where $d\lambda$ is the steplength in the wavelength array. Doing will compute the equivalent width for the Schuster-Schwarzschild profile seen in figure $$

\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{SSA/figures/ss2.pdf}
	\caption{Schuster-Schwarzschild line profile for $\lambda = 5000$.}
	\label{fig:25}
\end{figure}
