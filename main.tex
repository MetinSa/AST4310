...
We begin by computing the partition function $U_r$ of E found in equation \eqref{eq:2}. The results is seen in figure \ref{fig:1}.
...
\noindent We note that partition function of element E is of order unity and appears to be weakly sensitive to temperature.
...
We see that in thermal equilibrium for all temperatures, the ground state always has the largest population.
